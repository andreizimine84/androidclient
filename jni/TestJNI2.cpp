...
#define MESSAGE         "Yow!!! Are we having fun yet?!?"
 ...
 extern "C" {
     JNIEXPORT jstring JNICALL Java_com_helloworld_testjni2_TestJNIActivity_stringFromJNICPP(JNIEnv * env, jobject obj);
     JNIEXPORT void JNICALL Java_com_helloworld_testjni2_TestJNIActivity_connectToHostJNICPP(JNIEnv * env, jobject obj, jstring port, jstring addr, jstring data);
 };
 ...
 JNIEXPORT void JNICALL Java_com_helloworld_testjni2_TestJNIActivity_connectToHostJNICPP(
